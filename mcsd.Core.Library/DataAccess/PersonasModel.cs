...
namespace mcsd.Library.DataAccess
{
    public class PersonasModel
    {
        ...
        public DataTable ListadoPersonasDataTable()
        {
            ...
            {
                //
                using (var connection = new SqlConnection(this.constring))
                {
                    using (var command = new SqlCommand(tsql, connection))
                    {
        ...
        public List<PersonaEntity> ListadoPersonas()
        {
              ...
              try
              {
                  ...
                  using (var connection = new SqlConnection(this.constring))
                  {
                      ...
                      connection.Open();
                      //
                      listPersona = PersonasModel.SelectPersona(connection);
                  }
                  //
                  return listPersona;
              }
        ...
        public List<PersonaEntity> ListadoPersonasSTAT()
        {
            ...
            try
            {
                ...
                using (var connection = new SqlConnection(this.constring))
                {
                    ...
                    connection.Open();
                    //
                    listPersona = PersonasModel.SelectPersonaSTAT(connection);
                }
                //
                return listPersona;
            }
